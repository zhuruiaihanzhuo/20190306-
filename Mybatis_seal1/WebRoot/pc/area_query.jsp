...
<!-- 	<div class="easyui-layout" data-options="fit:true"> -->
					...
					<div class="easyui-panel"  id="dg" data-options="fit:true,title:'<center>区域信息查询</center>',tools:'#tool'">
						<table id="dg1">
							<thead>
								<tr>
									...
									<th data-options="field:'quyudaima',sortable:true,order:'asc',width:fixWidth(0.1),sortable:true">区域代码</th>
									
									<th data-options="field:'shuoming',align:'center',width:fixWidth(0.1),sortable:true">说明
										</th>
									
									
									<th data-options="field:'zerenbumen',align:'center',width:fixWidth(0.2),sortable:true">责任部门</th>
