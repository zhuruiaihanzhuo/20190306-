...
<body style="padding: 5px">
	...
	<div class="easyui-layout" data-options="fit:true">
					...
					<div class="easyui-panel"  id="dg" data-options="fit:true,title:'<center>消防设备信息查询</center>'">
						<table id="dg1">
							<thead>
								<tr>
									...
									<th data-options="field:'sqshuliang',align:'center',width:fixWidth(0.1),sortable:true">水枪
										...
										<th data-options="field:'sdshuliang',align:'center',width:fixWidth(0.1),sortable:true">水带
										</th>
